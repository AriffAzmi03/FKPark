                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class='action-column'>
                                            <a href="admin-view-summon.php?summonID=<?php echo $row['summonID']; ?>" class="btn btn-primary btn-sm mr-1 mb-1"><i class="fas fa-eye"></i> View</a>
                                            <a href="admin-manage-summon.php?del=<?php echo $row['summonID']; ?>" class="btn btn-danger btn-sm mb-1" onclick="return confirm('Are you sure you want to delete this summon?');"><i class="fas fa-trash"></i> Delete</a>
                                        </td>
                                    </tr>
                                    <?php
                                    }
